...
class Nuoli
{
    ...
    // Getterit joita ei edes käytetä koodissa
    public Head GetHead { get { return _head; } }
    public Fletching GetFletching { get { return _fletching; } }
    public int GetShaft { get { return _shaft; } }
    public double Hinta()
    {
        double hinta = 0;
        switch (_head)
